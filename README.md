...
### Creative Portion Description(20 Points) ###
* Cart: users can add multiple items to their cart so they can purchase multiple items at once
* Search feature: users can enter multiple tags to search for items.  Items are matched using regex
* Users can filter items by category
* Users can filter by maximum price
* Users can add money to their account by pressing their balance
* Users can edit items that they put up on sale (other users cannot)
